...
```
cd existing_repo
git remote add origin https://gitlab.cc-asp.fraunhofer.de/ipa326/demonstrator/prbt_cell.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.cc-asp.fraunhofer.de/ipa326/demonstrator/prbt_cell/-/settings/integrations)
